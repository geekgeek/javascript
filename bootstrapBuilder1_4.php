...
<div class="container">
    ...
    <h2>Bootstrap builder</h2>
        <div class="row">
            <div class="col-md-12">
                ...
                <!--ADMIN DIVS:-->
                <input class="btn btn-success" type="button" value="Admin" onclick="showHideT('#adminDiv')">
                <div id="adminDiv"><!--Box1 -->
                    <form action="includedFiles/formSubmit2.php" method="post" >
                        Array Group:<br><input type="text" name="arrayGroup" id="arrayGroup" value="$arrBootstrap"><br>
                        Key:<br><input type="text" name="arrayKey" id="arrayKey"><br>
                        Value: <br> <textarea name="arrayValue"  rows="5" cols="120" id="arrayValue"></textarea><br>
    ...
    <!--VIEW DIV:-->  
      <div class="row"><!--Box3 -->
            ...
            <!--EXTRA DIV:-->  
        <div class="row"><!--Box3 -->
            <div class="col-md-6" id="custom1">

            </div>
            
            <div class="col-md-6" id="custom2">
...
$( document ).ready(function() 
{
  ...
  startUpCode();
  //module_onClickedInside("#custom1","#custom2");
  //module_calculatorResistance("#custom");
...
function module_calculatorResistance(addModuleTo)
{
    //Set the module in document ready
    
    addToDiv = addModuleTo;
    
    $(addToDiv).parent().prepend('<h2>Calculate Resistance</h2><br>');
    //create array
    var arrAddStuff = 
    [
    ' Voltage:<br><input type="text" name="firstname" id="volt"><br>',
    ' Amps:<br><input type="text" name="firstname" id="amps"><br>',
    ' Sum resistance:<br><input type="text" name="firstname" id="resistance"><br>',
    ' <input type="button" value="Calculate" onclick="customFunction1()"><br>',
    '<script> function customFunction1(){var volt = $("#volt").val(); var amps = $("#amps").val(); var resistance = $("#resistance"); var sum = volt/amps; resistance.val(sum); }'+ '<'+'/script>'
    ];
    ...
    for (i = 0; i < arrAddStuff.length; i++) 
    {
       $(addToDiv).append(arrAddStuff[i]);
    } 
...
function module_onClickedInside(addModuleTo, copyTextTo)
{
    
    addToDiv = addModuleTo;
    copyToDiv =copyTextTo;
    insideCopyStyle ="<br>";
    ...
    $(addToDiv).parent().prepend('<h2>When selected text</h2><br>');
    for (i = 0; i < arrAddedText.length; i++) 
    {
       $(addToDiv).append(' <input value="'+arrAddedText[i]+'" onClick="customFunc'+i+'()" class="textClass" id="textboxIn'+i+'"/><br>');
       $(addToDiv).append('<script> function customFunc'+i+'(){var x = $("#textboxIn'+i+'").val(); $("'+copyToDiv+'").append(x); $("'+copyToDiv+'").append("'+insideCopyStyle+'"); }'+ '<'+'/script>');
    } 
...
function module_WebHistory(addModuleTo)
{
      addToDiv = addModuleTo;
